...
if($tabUser['contact_mail'] && $tabUser['contact_subject'] && $tabUser['contact_text']){
  ...
  $add_request_contact->bindValue('user_mail', Chiffrement::crypt($tabUser['contact_mail']), PDO::PARAM_STR);
  $add_request_contact->bindValue('request_subject', Chiffrement::crypt($tabUser['contact_subject']), PDO::PARAM_STR);
  $add_request_contact->bindValue('request_text', Chiffrement::crypt($tabUser['contact_text']), PDO::PARAM_STR);
